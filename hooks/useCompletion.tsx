...
const CompletionContext = createContext<CompletionContextProps>({} as CompletionContextProps);

const CompletionReducer = function (state: CompletionState, action: CompletionAction) {
  switch (action.type) {
